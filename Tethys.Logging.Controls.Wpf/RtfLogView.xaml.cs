...
namespace Tethys.Logging.Controls.Wpf
{
    ...
    // ReSharper restore RedundantExtendsListEntry
    {
        ...
        {
            var textRange = new TextRange(this.RtfBox.Document.ContentStart,
        ...
        private void AppendTextInternal(string text, Brush color)
        {
            ...
            if (this.AddAtTail)
            {
                tr = new TextRange(this.RtfBox.Document.ContentEnd,
                                   this.RtfBox.Document.ContentEnd);
            }
            else
            {
                tr = new TextRange(this.RtfBox.Document.ContentStart,
