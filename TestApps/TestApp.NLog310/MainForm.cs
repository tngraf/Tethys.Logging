...
namespace TestApp.NLog310
{
    ...
    public partial class MainForm : Form
    {
        ...
        private static void DisplayConfiguration()
        {
            ...
            foreach (var t in global::NLog.LogManager.Configuration.ConfiguredNamedTargets)
            {
                Debug.WriteLine($"Target = {t}");
            } // foreach

            Debug.WriteLine("Rules:");
            foreach (var r in global::NLog.LogManager.Configuration.LoggingRules)
            {
                Debug.WriteLine($"Rule = {r}");
                Debug.WriteLine("Targets for this rule:");
                foreach (NLog.Targets.Target t in r.Targets)
                {
                    Debug.WriteLine($"  Target = {t}");
                } // foreach
            } // foreach
